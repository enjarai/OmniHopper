...
public class ModBlocks {
    ...
    private static Block register(String name, Block block) {
        return Registry.register(Registry.BLOCK, OmniHopper.id(name), block);
    }
    ...
    public static void register() {
        ...
        Registry.register(Registry.BLOCK_ENTITY_TYPE, OmniHopper.id("wooden_omnihopper"), WOODEN_OMNIHOPPER_BLOCK_ENTITY);
        Registry.register(Registry.BLOCK_ENTITY_TYPE, OmniHopper.id("wooden_hopper"), WOODEN_HOPPER_BLOCK_ENTITY);

        Registry.register(Registry.BLOCK_ENTITY_TYPE, OmniHopper.id("open_box"), OPEN_BOX_BLOCK_ENTITY);
