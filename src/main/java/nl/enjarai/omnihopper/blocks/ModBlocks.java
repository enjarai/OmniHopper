...
public class ModBlocks {
    ...
    // Wooden OmniHopper
    public static final Block WOODEN_OMNIHOPPER_BLOCK = new WoodenOmniHopperBlock(OMNIHOPPER_BLOCK_SETTINGS);
    ...
    // Basic Wooden Hopper
    public static final Block WOODEN_HOPPER_BLOCK = new WoodenHopperBlock(OMNIHOPPER_BLOCK_SETTINGS);
    ...
    public static void register() {
        ...
        Registry.register(Registries.BLOCK, OmniHopper.id("wooden_omnihopper"), WOODEN_OMNIHOPPER_BLOCK);
        Registry.register(Registries.BLOCK, OmniHopper.id("wooden_hopper"), WOODEN_HOPPER_BLOCK);
